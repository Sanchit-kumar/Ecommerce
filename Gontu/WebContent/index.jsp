					...
					<div class="row">
						...
						<div class="col-sm-6">
								<div class="input-group date">
									...
									<input type="date" class="form-control date" name="dob" placeholder="Date of Birth" id="dob" />
								</div>
						</div>
						<div class="col-sm-3">
						</div>
					...
					<div class="row">
						...
						<div class="col-sm-6">
								<div class="input-group">
									...
									<input type="text" id="mob" name="mobile" class="form-control" placeholder="Mobile">
								</div>
						</div>
						<div class="col-sm-3">
						</div>
